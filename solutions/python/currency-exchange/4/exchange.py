...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    sum_exchange = (exchange_rate * (spread * 0.01)) + exchange_rate
    curr_exchange = budget / sum_exchange
    deno_rate = curr_exchange // denomination
    return denomination * deno_rate
